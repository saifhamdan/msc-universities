...
- Current status: Interesting option that needs closer program review
- Research status: Initial draft based on personal notes and official homepage verification

## Why it belongs on the list

Passau is interesting because it seems to combine a strong student-city environment with visible digitalisation themes and at least one AI-related master's path.

## What the university is known for

- Strong focus areas in digitalisation, Europe, and sustainability.
- Clear visibility of master's offerings, including AI-related options.
- Well-known student-city atmosphere and a generally attractive academic environment.

## City and living context

- Passau is a smaller city with a strong student identity.
- It may offer a more manageable living environment than the largest German cities.
- This could be attractive if the academic fit is stronger than expected.

## Facts captured so far

- Current spreadsheet fee signal: 372.8.
- Current note says direct applications run 15 April to 31 May.
- Current note says uni-assist applications run 1 April to 31 May.
- Current note says B2.

## Official starting points

- University website: https://www.uni-passau.de/en/
...
- Which exact master's options are strongest for my profile?
- How theoretical versus applied are the relevant programs?
- Is Passau strong enough in CS depth compared with Saarland, Paderborn, or Darmstadt?
